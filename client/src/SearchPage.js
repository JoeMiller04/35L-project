...
function SearchPage() {
    ...
    // Now you can use 'passedClass' in your component

    function doIt() {
        alert(JSON.stringify(passedObject, null, 2));
    }
         ...
         <div style={{ display: 'flex', backgroundColor: '#f0f0f0', minHeight: '100vh' }}>
            ...
            <div style={{ width: '80%', marginLeft: '10%', zIndex: 2 }}>
             <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <h1 style={{ textAlign: 'center', fontSize: '50px' }}>Class Information</h1>
                    <button onClick={doIt} style={{cursor:'pointer', backgroundColor:'white', marginRight:'100px', padding: '10px 20px', fontSize: '16px', marginTop:'10px' }}>View Classes</button>
                </div>
