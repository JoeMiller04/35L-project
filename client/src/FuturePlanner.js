...
{/* Dropdowns to select term and course, displayed only if degree is selected */}
      ...
      <button onClick={()=>{handleValidation()}} style={{ width: '110px', height: '30px', backgroundColor: 'white', border: '2px solid black', borderRadius: '4px', fontSize: '14px', cursor: 'pointer', marginLeft:'40px' }}> Validate Plan</button>
